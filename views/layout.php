...
<head>
    ...
    <link rel="shortcut icon" href="<?= asset('images/medico.jpg') ?>" type="image/x-icon">
    <link rel="stylesheet" href="<?= asset('build/styles.css') ?>">
    <title>Hospital Ramirez</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
        ...
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="/ejemplo/">
                <img src="<?= asset('./images/medico.jpg') ?>" width="35px'" alt="cit" >
                Aplicaciones
            </a>
            <div class="collapse navbar-collapse" id="navbarToggler">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="margin: 0;">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="/final_IS2_marin/"><i class="bi bi-house-fill me-2"></i>Inicio</a>
                    </li>
                    ...
                    <div class="nav-item dropdown " >
                        ...
                        <ul class="dropdown-menu  dropdown-menu-dark "id="dropwdownRevision" style="margin: 0;">
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/final_IS2_marin/especialidades"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>Especialidades</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item nav-link text-white " href="/final_IS2_marin/detallecitas"><i class="ms-lg-0 ms-2 bi bi-plus-circle me-2"></i>Detalles citas</a>
                            </li>
